...
*[Step 0: Download PHG Docker](user_instructions/create_phg_step0_main.md)*
[![CreatePHGDatabase_step0.png](images/CreatePHG_step0.png)](user_instructions/create_phg_step0_main.md)
...
*[Step 1: create an initial PHG with reference data](user_instructions/create_phg_step1_2_main.md)*
[![CreatePHGDatabase_step1.png](images/CreatePHG_step1.png)](user_instructions/create_phg_step1_2_main.md)

*[Step 2: add haplotypes](user_instructions/create_phg_step1_2_main.md)*
[![CreatePHGDatabase_step2.png](images/CreatePHG_step2.png)](user_instructions/create_phg_step1_2_main.md)
...
*Step 2.5: Optional (recommended) [Update PHG database schema](user_instructions/update_phg_schema.md)*
