...
| `--use-big-discard-set`    | A flag to use a different data structure to hold the discard set at the expense of RAM and speed.  If the default option fails due to an error consider enabling this flag.                       |                        |
